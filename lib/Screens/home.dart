...
String address="",bankName="",accountNumber="",ifscCode= "",accountName = "",image = "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Color(0xff7DAF45),
        actions: [
          Container(
            child: Row(
              children: [
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        item.itemList![0].accept_reject_driver=="0"?!loading?Container(
          ...
          children: [
            Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("$WALLET_BAL: $CUR_BALANCE"  + " " + CUR_CURRENCY!,
                        style: Theme.of(context)
                            .textTheme
                            .caption!
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: image!=""?Image.network(image):Center(child: CircularProgressIndicator(),),
              ),
            ),
          ],
        ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(" Payable: ${model.payable!}"  "${CUR_CURRENCY!}"),
                      ],
                    ),
                    Spacer(),
                    Row(
  ...
  Future<void> getSetting() async {
    try {
      ...
      await post(getSettingApi, body: parameter, headers: headers)
          .timeout(Duration(seconds: timeOut));
      print("AAAAAAAAAAAAA${getSettingApi.toString()}");
      print(parameter.toString());
  ...
  Future<Null> acceptStatus(orderId,status) async {
    ...
    if (_isNetworkAvail) {
      ...
      try {
        ...
        CUR_USERID = await getPrefrence(ID);
        var parameter = {"order_id": orderId,  "accept_reject": status, "delivery_boy_id" : CUR_USERID};

        print(parameter);
        print(acceptStatusApi);
        Response response =
