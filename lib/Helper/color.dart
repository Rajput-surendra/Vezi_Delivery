...
const Color primary = Color(0xff5D942C);
const Color secondary = Color(0xffFB6803);
const Color fontColor = Color(0xff5D942C);
const Color grad1Color = Color(0xff5D942C);
const Color grad2Color = Color(0xffFB6803);
const Color lightWhite2 = Color(0xffEEF2F3);

const Color disableColor = Color(0xffEEF2F9);
const Color pink = Color(0xff5D942C);
